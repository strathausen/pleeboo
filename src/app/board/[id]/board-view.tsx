...
import { Edit3, Eye, Loader2, Share2 } from "lucide-react";
...
export default function BoardView() {
  ...
  // Validate token and set access level
  ...
  // Update local board when server data changes and save to history
  useEffect(() => {
    if (board) {
      setLocalBoard(board);
  ...
  // Only allow edit mode if admin access
